						...
						<div class="card-body">
							<form action="joblist.php" method="get">
								<div class="row g-3 align-items-center">
									...
									<div class="col-auto" style="margin-top: 5px;">
										<button class="bx bx-refresh" onclick="window.location.href='joblist.php'"></button>
									</div>
								</div>
							</form>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                if ($row['status'] == 'OPEN') {
                                                    echo '<span class="badge rounded-pill bg-success">OPEN</span>';
                                                } elseif ($row['status'] == 'REPORT') {
                                                    echo '<span class="badge rounded-pill bg-warning">REPORT</span>';
                                                } elseif ($row['status'] == 'CLOSE') {
                                                    echo '<span class="badge rounded-pill bg-danger">CLOSE</span>';
                                                } elseif ($row['status'] == 'PROCESS') {
                                                    echo '<span class="badge rounded-pill bg-primary">PROCESS</span>';
                                                } elseif ($row['status'] == 'SUNDUL') {
                                                    echo '<span class="badge rounded-pill bg-secondary">SUNDUL</span>';
                                                } elseif ($row['status'] == 'USULAN') {
                                                    echo '<span class="badge rounded-pill bg-info">USULAN</span>';
                                                } elseif ($row['status'] == 'INFORMASI') {
                                                    echo '<span class="badge rounded-pill bg-light text-dark">INFORMASI</span>';
                                                } elseif ($row['status'] == 'MONITOR') {
                                                    echo '<span class="badge rounded-pill bg-dark text-white">MONITOR</span>';
                                                }
                                                ?>
                                            </td>
