					...
					<div class="modal-content">
						...
						<form method="POST" action="action/addJob.php" enctype="multipart/form-data">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-select" name="grup" placeholder="pilih grup" required>
												...
												<option value="ALLGRUP">ALL GRUP</option>
							...
							<div class="modal-footer">
								<button type="button" class="modal-btn-cancel" style="background-color: darkred;" data-bs-dismiss="modal">Cancel</button>
	...
	<script>
		function filterTable() {
			...
			tableRows.forEach(function(row) {
				...
				var joblist = columns[1].querySelector(".badge").textContent.toLowerCase();
				var status = columns[2].querySelector(".badge").textContent.toLowerCase();
				var category = columns[5].querySelector(".badge").textContent.toLowerCase();

				if (
					(joblistFilter === "all" || joblist === joblistFilter) &&
